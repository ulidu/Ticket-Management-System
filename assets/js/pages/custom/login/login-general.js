                    ...
                    if (data.toString() == 1){
                        ...
                        setTimeout(function () {
                            ...
                            swal.fire({
                                position: 'center',
                                type: 'success',
                                title: 'Password recovery instructions has been sent to your email. <br>Don\'t forget to check your Spam folder and you can ignore the Spam alert.<br><br>It will take about 5-10 minutes.',
