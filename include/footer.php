...
<div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-footer__menu">
            ...
            <a href="assets/profile/index.php" target="_blank" class="kt-footer__menu-link kt-link"><svg style="margin-top: -1%;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
